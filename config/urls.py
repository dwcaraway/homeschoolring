...
urlpatterns = [
    ...
    # User management
    url(r'^users/', include("hsr.users.urls", namespace="users")),
...
urlpatterns += patterns('',
    ...
    url("^account-favourite-ads\.html$", direct_to_template, {"template": "account-favourite-ads.html"}, name="account-favorite-ads"),
